      ...
      <div className={`grid grid-cols-9 border-[1.8px] bg-white gap-3 ${status === 'Complete' && 'bg-gray-200'} `}>
        ...
        <div className="overflow-hidden flex items-center justify-center">
          <div className="flex items-center justify-center ">
            <div disabled={status !== 'Complete'} className={`${status === 'Complete' ? 'bg-[#bfee90] text-green-900 cursor-pointer' : 'bg-gray-300 text-gray-500 disabled:cursor-not-allowed'} inline-block flex items-center justify-center p-3 rounded-[50px]  `}>
