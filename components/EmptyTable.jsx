                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right">
                                    ...
                                    >
                                        <button className='middle flex justify-center items-center none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs bg-gray-500 text-white shadow-md shadow-gray-500/20 hover:shadow-lg hover:shadow-gray-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none'>
