                  ...
                  <div className="p-6 sm:p-16">
                      ...
                      <div className="mt-16 grid space-y-4">
                            ...
                            hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                              <div className="relative flex items-center space-x-4 justify-center ">
                                <div className='absolute left-0 flex items-center'>
                                  ...
                                  <Image height={25} width={25} src={google} className="absolute left-0 w-5" alt="google logo"/>
                                </div>
                          ...
                          <button onClick={SignInWithFacebook} className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 
                              ...
                              <div className="relative flex items-center space-x-4 justify-center ">
                                <div className='absolute left-0 flex items-center'>
                                  <Image height={25} width={25} src={facebook} className="absolute left-0 w-5" alt="Facebook logo" />
                                </div>
